 ...
 * 
 * This is a header-only library. Simply include dt.hpp:
 * @code
 * #include "dt.hpp"
 * @endcode
 * 
...
/**
 * @example formatting.cpp
 * Advanced formatting examples with various format specifiers
 */

/**
 * @example arithmetic.cpp
 * Date and time arithmetic operations with overflow handling
 */

/**
 * @example constexpr_usage.cpp
 * Compile-time date calculations using constexpr
 */
